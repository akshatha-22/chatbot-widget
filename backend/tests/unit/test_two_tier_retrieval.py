...
@patch("app.services.chat_service.build_rag_context", return_value=_DIRECT_RAG_CONTEXT)
def test_rag_hit_sets_document_source(
    ...
    response = client.post(
        ...
        json={"content": "What is the BP-4821 bearing"},
    )
...
def test_rag_miss_sets_web_source(
    mock_rag, mock_openai, mock_gemini, _mock_cfg, _mock_files, client, auth_headers, conversation_id
):
